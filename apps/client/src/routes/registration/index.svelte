...
<div class="flex flex-col h-full">
  <div class="header">
    <button on:click={() => selectedTab = RegistrationTabs.LogIn} class:active={selectedTab === RegistrationTabs.LogIn}>
      <span class="button-icon"><LoginCircleLine /></span>
      <span class="button-text">Log In</span>
    </button>
    <div class="mx-1"></div>
    <button on:click={() => selectedTab = RegistrationTabs.Register} class:active={selectedTab === RegistrationTabs.Register}>
