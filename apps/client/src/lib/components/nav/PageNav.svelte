...
<style lang="scss">
  ...
  div.pages :global {
    @apply w-full h-full overflow-y-auto flex flex-col px-4 py-4;
    form {
      @apply w-full mb-4;
      input {
        @apply w-full rounded-md border-transparent bg-gray-300 placeholder-gray-400 text-sm px-1.5 py-2.5 focus:border-gray-400 focus:ring-0;
